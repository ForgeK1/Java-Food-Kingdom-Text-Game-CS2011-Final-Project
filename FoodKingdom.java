    ...
    if(((int) (Math.random() * 2)) == 0) {
      ...
      switch(minigame) {
        ...
        case 2: hangMan(basket, numLosses);
                break;
        case 3: magician(basket, numLosses);
                break;
        case 4: betterHurry(basket, numLosses);
                break;
        case 5: ingredientInteraction(basket, numLosses);
                break;
        case 6: homelessMan(basket, numLosses);
                break;
        case 7: pickAChest(basket, numLosses);
                break;
...
*/
  ...
  public static void battleSystem (String[] basket, int[] numLosses){
    ...
    while(yourCurrentHP > 0 && enemyCurrentHP > 0 && battleStatus) {
      ...
      /*Check if player's health has reached zero or below. If it has, then the
      number losses increases*/
      if(yourCurrentHP < 0) {
        battleStatus = false;
...
/*-----------------Player's sumTotal vs Program's sumTotal--------------------*/
  ...
  public static void hangMan(String[] basket, int[] numLosses){
    ...
    ingredient in. If it can not find one and reaches the end
    of the array, then it will enter another loop where they
    have to replace one of their ingredients for the new
    one*/
                       int foodNum = -1;
                       int i = 0;
                       while(i <= 8){
  ...
  public static void betterHurry(String[] basket, int[] numLosses){
    Scanner input = new Scanner(System.in);
            ...
            if(dialogueSelection == 'b') {
              ...
              if(dialogueSelection == 'b') {
                ...
                if(dialogueSelection == 'b') {
                  ...
                  //FOOD MACHINE
                  /*The following loop iterates through every index of the array
                  in order to find an empty slot "" to place the new ingredient
                  in. If it can not find one and reaches the end of the array,
                  then it will enter another loop where they have to replace one
                  of their ingredients for the new one*/
                  foodNum = -1;
                  i = 0;
                  while(i <= 8){
                    if(i == 8){
  ...
  public static void homelessMan(String[] basket, int[] numLosses){
    Scanner input = new Scanner(System.in);
    //Story of the minigame
  ...
  public static void pickAChest(String[] basket, int[] numLosses){
    Scanner input = new Scanner(System.in);
