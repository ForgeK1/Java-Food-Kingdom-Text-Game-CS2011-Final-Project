...
public class IngredientInteraction {
  public static void main(String[] args) {
    ...
    do {
      System.out.println("Would like to grab this [ingredient]? "
                          + "Yes (y) or No (n)?");
      char selection = input.next().charAt(0);

      if(selection == 'y') {
        System.out.println("You decided to grab the [ingredient]. \n");
        ...
        if(dialogueRandomizer == 1) {
          System.out.println("[Ingredient]: Am I finally gonna be sold?!");
          System.out.println("The fuck? This [ingredient] talks?!"
          ...
          char dialogueSelection = input.next().charAt(0);
            ...
            if(dialogueSelection == 'a') {
              System.out.println("[Ingredient]: Ah, uhh, well, umm are you "
                                  + "gonna buy me? \n");
              System.out.println("After looking a bit closer to"
                                  + " this, uhh, sentient [ingredient] you see "
                                  + " some rotten spots on it. Gross. \n");
              System.out.println("(a) 'Ew this [ingredient] is gross, bye.' \n"
              ...
              dialogueSelection = input.next().charAt(0);
                ...
                if(dialogueSelection == 'a') {
                  System.out.println("You decide to leave this abomination"
                                      + " alone.");
                  System.out.println("[Ingredient]: NOOOO PLEASE COME BACK!"
                ...
                if(dialogueSelection == 'b') {
                  System.out.println("[Ingredient]: Well... It's because I... "
                  ...
                  System.out.println("(a) 'Yep you're right I'm not gonna buy "
                    ...
                    if(dialogueSelection == 'a') {
                      System.out.println("You decide to leave this abomination"
                                          + " alone.");
                      System.out.println("[Ingredient]: Of course... I am "
                    ...
                    if(dialogueSelection == 'b') {
                      System.out.println("[Ingredient]: Me? Needed? But I am"
                                          + " rotten. You wouldn't want buy"
                                          + " a [ingredient] that is spoiled,"
                                          + " would you?");
                      ...
                      if(dialogueSelection == 'a') {
                        System.out.println("[Ingredient]: Oh, y-yay... \n");
                        System.out.println("Well looks like you made a mistake "
                                            + "on buying this rotten piece of "
                                            + "crap. Don't blame me if you get "
                                            + "executed. \n"
                                            + "You got a rotten [ingredient]");
                        talkWithIngredient = false;
                      }

                      if(dialogueSelection == 'b') {
                        System.out.println("[Ingredient]: But I'm rotten. How "
                                            + "can a rotten [ingredient] like "
                                            + "me heal the king? \n");
                        ...
                        if(dialogueSelection == 'a') {
                          System.out.println("[Ingredient]: R-really? Thank you!");
                          System.out.println("The rotten [ingredient] "
            ...
            System.out.println("[Ingredient]: Oh me?! Well I am a special "
            ...
            System.out.println("Well I caught none of that, and I don't wanna "
                                + "deal with a talking [ingredient]. And I'm "
            ...
            if(dialogueSelection == 'b') {
              System.out.println("[Ingredient]: Huh... R-REALLY?! WILL YOU "
                                  + " BUY ME THEN??? \n");
              ...
              System.out.println("(a)'Huh... uhhhh nuh uh. I'm not buying no "
                                  + "rotten ass [ingredient].' \n (b) 'Well why"
                                  + " not, buying a talking [ingredient] would "
                                  + "pretty neat' ");
              dialogueSelection = input.next().charAt(0);
              ...
              if(dialogueSelection == 'b') {
                System.out.println("[Ingredient]: But what's so neat about "
                                    + "buying a rotten [ingredient] like "
                                    + "me? \n");
                ...
                if(dialogueSelection == 'a') {
                  System.out.println("[Ingredient]: P-podium? You don't want "
                  ...
                  System.out.println("(a) 'Nope you could be a neat trophy that"
                                      ...
                                      + "you for my dish'");
                  dialogueSelection = input.next().charAt(0);
                  System.out.println("[Ingredient]: But that's not my purpose. "
                  ...
                  if(dialogueSelection == 'a') {
                    System.out.println("[Ingredient]: NO NO NO I DON'T WANNA "
                  ...
                  if(dialogueSelection == 'b') {
                    System.out.println("[Ingredient]: R-really? You would do "
        ...
        if(dialogueRandomizer == 2) {
          System.out.println("[Ingredient]: YOU PUT YOUR FILTHY HANDS AWAY FROM"
                              + "ME OR ELSE!!! \n");
          System.out.println("The fuck? This [ingredient] talks?! Well, uhh,"
                              +" how do you respond? \n");
          ...
          if(dialogueSelection == 'a') {
            System.out.println("[Ingredient]: YOU WANNA FIGHT ME? COME AT ME, "
            ...
            System.out.println("(a) 'What? I'm not fighting you, besides why "
                                ...
                                + "tiny [ingredient] ass can't do shit to me.'");
            dialogueSelection = input.next().charAt(0);

            if(dialogueSelection == 'a') {
              System.out.println("[Ingredient]: I'M HEATED BECAUSE I AM CREATED"
              ...
              if(dialogueSelection == 'a') {
                System.out.println("[Ingredient]: I DON'T GIVE A DAMN ABOUT "
                                    + "SOME HUMAN! GO AWAY! \n");
                System.out.println("Alright, looks like this thing doesn't "
                                    + "wanna be bothered. Lets go somewhere "
                                    + "else with no annoying [ingredient]. \n");
                System.out.println("(a) 'Ok.' \n (b) 'No I am not gonna go "
                                    + "away, I am gonna help you.");
                dialogueSelection = input.next().charAt(0);

                if(dialogueSelection == 'a') {
                  System.out.println("You left that [ingredient] alone");
                  talkWithIngredient = false;
                }

                if(dialogueSelection == 'b') {
                  System.out.println("[Ingredient]: HELP ME? HOW? FORCE ME TO "
            ...
            if(dialogueSelection == 'b') {
              System.out.println("[Ingredient]: YOU CAN'T SCARE ME, I HEARD "
            ...
            System.out.println("[Ingredient]: ME?! CALM DOWN?!!! I AM PUT INTO"
            ...
            if(dialogueSelection == 'a') {
              System.out.println("You left the very angry [ingredient] that "
                                  + "cursed its fate alone.");
              talkWithIngredient = false;
            }

            if(dialogueSelection == 'b') {
              System.out.println("[Ingredient]: You can help me by LEAVING ME "
                                  + "THE HELL ALONE!!! \n");
              System.out.println("Cmon, clearly this thing doesn't want you "
                                  + "here, lets go. \n");
              System.out.println("(a) Leave the [ingredient] be. \n"
              ...
              if(dialogueSelection == 'b') {
                System.out.println("[Ingredient]: Why would I care about the "
        ...
        if(dialogueRandomizer == 3) {
          System.out.println("[Ingredient]: Hey what's up. \n");
          System.out.println("The fuck? This [ingredient] talks?! Well, uhh,"
                              +" how do you respond? \n");
          ...
          if(dialogueSelection == 'a') {
            System.out.println("[Ingredient]: I'm just a [ingredient] that can "
                                + "talk. You wanna buy me? \n");
            System.out.println("A talking [ingredient]? That's a first for me"
                                + "\n");
            System.out.println("(a) 'Nah I'm good, bye.' \n (b) 'Yeah sure.'");
            dialogueSelection = input.next().charAt(0);

            if(dialogueSelection == 'a') {
              System.out.println("[Ingredient]: Alright I respect that, have a "
                                  + "good one bro. \n");
              System.out.println("Huh, what a chill [ingredient]. Kinda wish "
                                  + "you would bought it. Oh well.");
              talkWithIngredient = false;
            }

            if(dialogueSelection == 'b') {
              System.out.println("[Ingredient]: Alright bro, I can help you "
                                  + "however I can. \n");
            ...
            System.out.println("[Ingredient]: I'm doing all good bro. How "
                                + "about you? \n");
            ...
            if(dialogueSelection == 'a') {
              System.out.println("[Ingredient]: Go for it man, I don't mind. \n");
              System.out.println("What a chill [ingredient]. \n Looks like "
                                  + "you got a [ingredient].");
              talkWithIngredient = false;
            }

            if(dialogueSelection == 'b') {
              System.out.println("[Ingredient]: Alright, it's all good bro. "
                                  + "You have a good one.");
              System.out.println("What? We are leaving that chill [ingredient]?"
                                  + " What a shame... \n You left the "
                                  + "[ingredient].");
              talkWithIngredient = false;
            }
